...
<div class="container">
    <div class="form-card">
        <div class="card-header">
            <h3><i class="fas fa-user-plus"></i> 添加教师信息</h3>
            <a href="lwmteacherlist.jsp" class="btn-back">
        ...
        <div class="form-body">
            ...
            <!-- 添加教师表单 -->
            <form action="lwmAddteacher" method="post" onsubmit="return validateForm()">
                <div class="form-group">
                    ...
                    <input type="text" name="lwmteacherno" id="lwmteacherno" class="form-control"
                           placeholder="请输入工号，例如：2021001" required maxlength="20">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="radio-group">
                        <label class="radio-label">
                            <input type="radio" name="lwmteachergender" value="男" checked> 男
                        </label>
                        <label class="radio-label">
                            <input type="radio" name="lwmteachergender" value="女"> 女
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="lwmteacherphone" id="lwmteacherphone" class="form-control"
                           placeholder="请输入联系电话" required maxlength="20">
                </div>

                <div class="form-actions">
                    <button type="submit" class="btn-submit">
                        <i class="fas fa-save"></i> 添加教师
                    </button>
...
<script>
    ...
    document.getElementById('togglePassword').addEventListener('click', function () {
        const passwordInput = document.getElementById('lwmteacherpassword');
