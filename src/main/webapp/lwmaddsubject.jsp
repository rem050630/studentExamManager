...
<div class="container">
    <div class="form-card">
        <div class="card-header">
            <h3><i class="fas fa-book"></i> 添加课程信息</h3>
            <a href="lwmsubjectlist.jsp" class="btn-back">
        ...
        <div class="form-body">
            ...
            <!-- 添加课程表单 -->
            <form action="lwmAddsubject" method="post" onsubmit="return validateForm()">
                <div class="form-group">
                    ...
                    <input type="text" name="lwmsubjectname" id="lwmsubjectname" class="form-control"
                           placeholder="请输入课程名称" required maxlength="50">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="lwmsubjectdesc" id="lwmsubjectdesc" class="form-control"
                           placeholder="请输入课程描述" required maxlength="200">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="lwmsubjectscore" id="lwmsubjectscore" class="form-control"
                           placeholder="请输入课程学分（1-10）" required min="1" max="10">
                </div>
